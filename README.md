...
├── server-api.js  # REST API и база данных (Express + SQLite): npm run api
├── database.js    # Работа с SQLite (карта, пользователи, история, настройки)
├── data/          # Папка с файлом базы network-map.db (создаётся при первом запуске API)
