...
- **Фильтр карты** — показ только выбранных типов (узлы, кроссы, муфты, опоры, крепление); кабели отображаются только между видимыми объектами
- **Экспорт / Импорт** — JSON
...
| Оптический кросс | Соединение жил между кабелями, вывод жил на узлы («Подключить к узлу») |
